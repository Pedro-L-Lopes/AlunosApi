...
namespace AlunosApi.Services
{
    public class AuthenticateService : IAuthenticate
    {
        ...
        private readonly UserManager<IdentityUser> _usernManager;

        public AuthenticateService(SignInManager<IdentityUser> signInManager, 
                                            UserManager<IdentityUser> usernManager)
        {
        ...
        public async Task<bool> RegisterUser(string email, string password)
        {
            ...
            var result = await _usernManager.CreateAsync(appUser, password);
